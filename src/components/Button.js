...
export default function Button({ btnName, addClass, updateCalc }) {
  let btnStyle = 'border-white select-none border-2 w-1/4 h-12 flex justify-center items-center bg-red-500 text-white font-black cursor-pointer hover:bg-red-900 text-xl';
  btnStyle += ` ${addClass}`;
